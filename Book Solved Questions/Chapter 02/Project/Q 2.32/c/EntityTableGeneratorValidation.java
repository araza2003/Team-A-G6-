...
public class EntityTableGeneratorValidation {
    public static void main(String[] args) {
        try {
            // User inputs: URL and output file name
            ...
            // Fixing deprecated URL constructor (Java 20+)
            ...
            // XHTML document header with 1.0 Strict compliance
            ...
            xhtmlContent.append("<title>XHTML Entity Test</title>\n</head>\n<body>\n");
            ...
            // Regular expression to extract entity names from XHTML entity declaration
            ...
            // Close the table and add validation link
            ...
            // Write the XHTML content to the specified output file
            BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile));
            writer.write(xhtmlContent.toString());
            writer.close();

            System.out.println("XHTML document generated successfully. Open in a browser and click 'Validate XHTML' to check compliance.");
